...
// Get by UUID
router.get('/:uuid', JWTValidator, productsGetByUuid);
...
// Create new
router.post('/', JWTValidator, productsPost);
...
// Update db entry
router.put('/:uuid', JWTValidator, productsPut);
...
// Soft delete entry
router.delete('/:uuid', JWTValidator, productsDelete);
